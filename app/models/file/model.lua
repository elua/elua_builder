...
ROMFS_V06 = {
				...
				{id="0.4",filename = 'lhttpd.lua', category= 'V0.6 File',created_at=""},
				{id="0.5",filename = 'test.lua', category= 'V0.6 File',created_at=""},
				{id="0.6",filename = 'pong.lua', category= 'V0.6 File',created_at=""},
				{id="0.7",filename = 'LM3S.lua', category= 'V0.6 File',created_at=""},
				{id="0.8",filename = 'led.lua', category= 'V0.6 File',created_at=""},
				{id="0.9",filename = 'piano.lua', category= 'V0.6 File',created_at=""},
				{id="0.10",filename = 'pwmled.lua', category= 'V0.6 File',created_at=""},
				{id="0.11",filename = 'tvbgone.lua', category= 'V0.6 File',created_at=""},
				{id="0.12",filename = 'codes.bin', category= 'V0.6 File',created_at=""},
				{id="0.13",filename = 'hello.lua', category= 'V0.6 File',created_at=""},
				{id="0.14",filename = 'info.lua', category= 'V0.6 File',created_at=""},
				{id="0.15",filename = 'morse.lua', category= 'V0.6 File',created_at=""},
				{id="0.16",filename = 'dualpwm.lua', category= 'V0.6 File',created_at=""},
				{id="0.17",filename = 'adcscope.lua', category= 'V0.6 File',created_at=""},
				{id="0.18",filename = 'adcpoll.lua', category= 'V0.6 File',created_at=""},
				{id="0.19",filename = 'life.lua', category= 'V0.6 File',created_at=""},
				{id="0.20",filename = 'logo.lua', category= 'V0.6 File',created_at=""}, 
				{id="0.21",filename = 'logo.bin', category= 'V0.6 File',created_at=""}, 
			}
