locale_index = {
	...
	file_bin_generated = 'Your build image was generated successfully. Please, download below the binary file.',
	build_error = 'Sorry, something wrong occured during the build image generation. Please, download the log errors below to know more.',
	download_binary_log = 'Download here',
	labels = {
				greeting = "Hello",
				filename = "File Name",
