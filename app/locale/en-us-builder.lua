locale_index = {
	...
	file_bin_generated = 'file .bin or .elf successfully generated.',
	build_error = 'Ocorreu erro na geração do build. Verifique o log de erros para maiores informações',
